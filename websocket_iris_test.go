...
func TestIrisConnectAndWait(t *testing.T) {
	var wss wsServer
...
func TestIrisMixedMessagesConcurrency(t *testing.T) {
	var wss wsServer
	var client ClientConnection
	var err error
	tries_left := int(10)
...
func TestIrisServerDisconnect(t *testing.T) {
	var wss wsServer
	var client ClientConnection
	var err error
	connected := true
...
func TestIrisNoServerDisconnect(t *testing.T) {
	var wss wsServer
	var client ClientConnection
	var err error
	connected := true
...
func TestIrisClientDisconnect(t *testing.T) {
	var wss wsServer
	var client ClientConnection
	var err error
	connected := true
